...
public class ExportExcel {
    ...
    public static void main(String[] args) throws Exception {
        String fileName = "文件名";
        String[] titles = {"哈哈"};
        String[] properties = {"异常单号", "异常原因"};
        List<A> list = Lists.newArrayList();
        A a = new A();
        a.setAbnormalCode("123");
        a.setAbnormalReason("321");
        list.add(a);
        HSSFWorkbook hssfWorkbook = exportExcel(fileName, titles, properties, list);
        writeFile(hssfWorkbook, "文件123");
        System.out.println(1);
    }

    public static File writeFile(Workbook workbook, String fileName) {
        File file = new File("/Users/hujiping/Downloads" + File.separator + fileName);
        ...
        try {
            ...
            log.error("导出写入文件异常, fileName:[{}]", fileName, e);
     ...
     */
    public static <T> void  exportFile(HttpServletResponse response, String fileName, String[] titles, String[] properties, List<T> list, String type) throws Exception {
